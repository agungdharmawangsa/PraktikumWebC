...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 29 Bulan Mei 2020 pada 08.12
...
(2, '0', '1234512345', 'Administrator', 'admin@gmail.com', 'singapore', '2020-04-28', '$2y$10$myFCUysMmWRR2PZ5NUcXqer1gK.TkrVEtMPXsPFzllHE/FgyCLO2C');
...
(1, '2', '1234567890', '1656312565', 'Taufik Hidayat', 'TaufikHidayat@gmail.com', 'Badung', '2020-05-19', 'aktif', '$2y$10$OZjJi2kW1CDIXeZ42ngAp.yuJG.nzBzzDwyFPGXXjMsQ.1/1ItoxO'),
(2, '2', '1231231231', '3434627346', 'Agus Kuncoro', 'Agus@gmail.com', 'Denpasar', '2020-04-29', 'aktif', '$2y$10$sXlj6kxyStGbqD6wlr6SgOj.kpNOPFW/nolcllq5llQGiB.xfPUjS'),
(3, '2', '1234567891', '2136147167', 'Ahmad Dhani', 'Dhani@gmail.com', 'Gianyar', '2020-05-26', 'aktif', '$2y$10$N9Jtnndos4OVEqDqKR8kXeSgUfMqkjV4uCU5d.BZs2rkIcMejbMYC');
...
(1, 'Algoritma Genetika', '12.00 - 14.50', 25, 2, 'aktif'),
(9, 'Kalkulus', '13.00 - 14.00', 21, 2, 'aktif');
...
(2, '1', '1708561077', 'Eddy M.', 'eddym@gmail.com', 'Badung', '2020-04-28', 'aktif', '$2y$10$ePnwfLXkebClZ8zVxS1KQeRPmoHI4uNhBuX54gFlEQurEg4RJ67KC');
...
(3, 'IF1236', 'Kalkulus', 3),
(4, 'IF1237', 'Kecerdasan Buatan Lanjut', 3);
